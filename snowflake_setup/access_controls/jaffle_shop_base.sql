...
CREATE ROLE DBT_FUNDAMENTALS_PROD_READ;
...
GRANT ROLE DBT_FUNDAMENTALS_PROD_READ           TO ROLE SYSADMIN;

// grant read access to prod to allow referencing of prod data in DEV and TEST
GRANT ROLE DBT_FUNDAMENTALS_PROD_READ           TO ROLE DBT_FUNDAMENTALS_DEV_READ_WRITE;
GRANT ROLE DBT_FUNDAMENTALS_PROD_READ           TO ROLE DBT_FUNDAMENTALS_TEST_READ_WRITE;
//=============================================================================
...
GRANT USAGE ON DATABASE DBT_FUNDAMENTALS_PROD TO ROLE DBT_FUNDAMENTALS_PROD_READ;
GRANT USAGE ON ALL SCHEMAS IN DATABASE DBT_FUNDAMENTALS_PROD  to role DBT_FUNDAMENTALS_PROD_READ;
GRANT SELECT ON ALL TABLES IN DATABASE DBT_FUNDAMENTALS_PROD to role DBT_FUNDAMENTALS_PROD_READ;
GRANT SELECT ON ALL VIEWS IN DATABASE DBT_FUNDAMENTALS_PROD to role DBT_FUNDAMENTALS_PROD_READ;

GRANT USAGE ON FUTURE SCHEMAS IN DATABASE DBT_FUNDAMENTALS_PROD  to role DBT_FUNDAMENTALS_PROD_READ;
GRANT SELECT ON FUTURE TABLES IN DATABASE DBT_FUNDAMENTALS_PROD to role DBT_FUNDAMENTALS_PROD_READ;
GRANT SELECT ON FUTURE VIEWS IN DATABASE DBT_FUNDAMENTALS_PROD to role DBT_FUNDAMENTALS_PROD_READ;
...
GRANT ROLE RAW_READ_ROLE                    TO ROLE DBT_FUNDAMENTALS_DEV_TRANSFORMER;
//=============================================================================
